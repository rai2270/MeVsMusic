...
public final class Bonus4ParticleSystem extends BaseObject3D {
	...
	private Bonus4ParticleMaterial mChordMat;
	...
	public Bonus4ParticleSystem(int numParticles) {
		super();
	...
	public void setMaterial(AMaterial material, boolean copyTextures) {
		...
		mChordMat = (Bonus4ParticleMaterial)material;
	}
