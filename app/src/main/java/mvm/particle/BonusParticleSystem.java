...
// Unified bonus pickup particle system. Replaces the identical Bonus1..6ParticleSystem
// classes; the renderer holds one instance per bonus type (texture differs per instance).
public final class BonusParticleSystem extends BaseObject3D {
	...
	public BonusParticleSystem(int numParticles) {
		super();
