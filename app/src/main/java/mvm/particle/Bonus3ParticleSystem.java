...
public final class Bonus3ParticleSystem extends BaseObject3D {
	...
	private Bonus3ParticleMaterial mChordMat;
	...
	public Bonus3ParticleSystem(int numParticles) {
		super();
	...
	public void setMaterial(AMaterial material, boolean copyTextures) {
		...
		mChordMat = (Bonus3ParticleMaterial)material;
	}
