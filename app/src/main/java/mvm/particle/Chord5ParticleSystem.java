...
public final class Chord5ParticleSystem extends BaseObject3D {
	...
	private Chord5ParticleMaterial mChordMat;
	...
	public Chord5ParticleSystem(int numParticles) {
		super();
	...
	public void setMaterial(AMaterial material, boolean copyTextures) {
		...
		mChordMat = (Chord5ParticleMaterial)material;
	}
