...
public final class Bonus1ParticleSystem extends BaseObject3D {
	...
	private Bonus1ParticleMaterial mChordMat;
	...
	public Bonus1ParticleSystem(int numParticles) {
		super();
	...
	public void setMaterial(AMaterial material, boolean copyTextures) {
		...
		mChordMat = (Bonus1ParticleMaterial)material;
	}
