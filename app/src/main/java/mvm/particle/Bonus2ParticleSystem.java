...
public final class Bonus2ParticleSystem extends BaseObject3D {
	...
	private Bonus2ParticleMaterial mChordMat;
	...
	public Bonus2ParticleSystem(int numParticles) {
		super();
	...
	public void setMaterial(AMaterial material, boolean copyTextures) {
		...
		mChordMat = (Bonus2ParticleMaterial)material;
	}
