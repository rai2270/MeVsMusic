...
public final class Bonus5ParticleSystem extends BaseObject3D {
	...
	private Bonus5ParticleMaterial mChordMat;
	...
	public Bonus5ParticleSystem(int numParticles) {
		super();
	...
	public void setMaterial(AMaterial material, boolean copyTextures) {
		...
		mChordMat = (Bonus5ParticleMaterial)material;
	}
