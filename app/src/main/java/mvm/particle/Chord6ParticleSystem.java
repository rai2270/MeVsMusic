...
public final class Chord6ParticleSystem extends BaseObject3D {
	...
	private Chord6ParticleMaterial mChordMat;
	...
	public Chord6ParticleSystem(int numParticles) {
		super();
	...
	public void setMaterial(AMaterial material, boolean copyTextures) {
		...
		mChordMat = (Chord6ParticleMaterial)material;
	}
