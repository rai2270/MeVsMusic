...
// Single material for all game point-sprite particles (chords, bonuses, bullets).
// Replaces the 10 identical per-type *ParticleMaterial classes.
public class GameParticleMaterial extends AMaterial {
	...
	public GameParticleMaterial() {
		this(false);
	}

	public GameParticleMaterial(boolean isAnimated) {
