...
import r.bounds.BoundingBox;
import r.lights.ALight;
import r.materials.AMaterial;
import r.materials.ColorPickerMaterial;
import r.materials.TextureInfo;
import r.materials.TextureManager.TextureType;
import r.math.Number3D;
import r.util.RajLog;
import r.util.ObjectColorPicker.ColorPickerInfo;
import r.visitors.INode;
import r.visitors.INodeVisitor;
